...
public class ModItem extends ModSource {
    ...
    public ModItem(int apiSource, boolean isModpack, String id, String title, String description, String imageUrl) {
        this(apiSource, isModpack, isModpack ? "modpack" : "mod", isModpack ? "mods" : "mods", id, title, description, imageUrl);
    }

    public ModItem(int apiSource, boolean isModpack, String projectType, String installSubdirectory,
                   String id, String title, String description, String imageUrl) {
        this.apiSource = apiSource;
        this.isModpack = isModpack;
        this.projectType = projectType;
        this.installSubdirectory = installSubdirectory;
        this.id = id;
        this.title = title;

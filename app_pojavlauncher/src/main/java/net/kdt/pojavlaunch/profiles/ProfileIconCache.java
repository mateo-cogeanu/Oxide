...
public class ProfileIconCache {
    ...
    private static final String[] BUILTIN_ICON_KEYS = new String[]{
            "default",
            "bee_legacy", "brick", "brick_legacy", "chicken_legacy",
            "creeper", "creeper_legacy", "diamond", "diamond_legacy", "dirt", "dirt_legacy",
            "enderman", "enderman_legacy", "enderpearl", "enderpearl_legacy", "fabricmc",
            "flame", "flame_legacy", "forge", "fox", "fox_legacy", "ftb_glow", "ftb_logo",
            "ftb_logo_legacy", "gear", "gear_legacy", "gold", "gold_legacy", "grass", "grass_legacy",
            "herobrine", "herobrine_legacy", "infinity_legacy", "iron", "iron_legacy", "liteloader",
            "magitech", "magitech_legacy", "meat", "meat_legacy", "modrinth", "neoforged",
            "netherstar", "netherstar_legacy", "planks", "planks_legacy", "prismlauncher",
            "quiltmc", "skeleton", "skeleton_legacy", "squarecreeper", "squarecreeper_legacy",
            "steve", "steve_legacy", "stone", "stone_legacy", "tnt", "tnt_legacy"
    };
    ...
    public static @NonNull String[] getBuiltinIconKeys() {
        return BUILTIN_ICON_KEYS.clone();
    }

    public static int getStaticIconResource(@Nullable String icon) {
        if(icon == null) return -1;
        if ("default".equals(icon)) return R.mipmap.ic_launcher_foreground;
        try {
            return R.drawable.class.getField("ic_instance_" + icon).getInt(null);

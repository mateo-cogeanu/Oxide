...
public class mcVersionSpinner extends ExtendedTextView {
    ...
    private Runnable mOnProfileSelectedListener;
    ...
    public void setProfileSelection(int position){
        ...
        if (mOnProfileSelectedListener != null) {
            mOnProfileSelectedListener.run();
        }
    }
    ...
    private void animateSelectionFeedback() {
        animate().cancel();
    ...
    private void animatePopupListIn() {
        if (mListView == null) return;
        mListView.setAlpha(0f);
        mListView.setTranslationY(18f);
        mListView.animate()
                .alpha(1f)
                .translationY(0f)
                .setDuration(180L)
    ...
    public void setOnProfileSelectedListener(@Nullable Runnable listener) {
